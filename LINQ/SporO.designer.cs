...
namespace LINQ
{
    ...
    partial void InsertKatilanlar(Katilanlar instance);
    partial void UpdateKatilanlar(Katilanlar instance);
    partial void DeleteKatilanlar(Katilanlar instance);
    ...
    partial void InsertKullaniciSpor(KullaniciSpor instance);
    partial void UpdateKullaniciSpor(KullaniciSpor instance);
    partial void DeleteKullaniciSpor(KullaniciSpor instance);
    ...
    partial void DeleteSporlar(Sporlar instance);
		...
		public SporODataContext() : 
				base(global::LINQ.Properties.Settings.Default.SporOConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.EtkinlikAl")]
		public ISingleResult<EtkinlikAlResult> EtkinlikAl()
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())));
			return ((ISingleResult<EtkinlikAlResult>)(result.ReturnValue));
		}
		
		[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.EtkinlikTarihKontrol")]
		public int EtkinlikTarihKontrol()
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())));
		...
		[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.KullaniciSporEkle")]
		public int KullaniciSporEkle([global::System.Data.Linq.Mapping.ParameterAttribute(DbType="Int")] System.Nullable<int> kid, [global::System.Data.Linq.Mapping.ParameterAttribute(DbType="Int")] System.Nullable<int> sid)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), kid, sid);
			return ((int)(result.ReturnValue));
		}
		
		[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.SonKullanici")]
		public int SonKullanici()
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())));
			return ((int)(result.ReturnValue));
		}
	...
	public partial class Etkinlik : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Katilanlar> _Katilanlars;
    ...
    partial void OnSidChanged();
		...
		public Etkinlik()
		{
			this._Katilanlars = new EntitySet<Katilanlar>(new Action<Katilanlar>(this.attach_Katilanlars), new Action<Katilanlar>(this.detach_Katilanlars));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Etkinlik_Katilanlar", Storage="_Katilanlars", ThisKey="EtkinlikId", OtherKey="Eid")]
		public EntitySet<Katilanlar> Katilanlars
		{
			get
			{
				return this._Katilanlars;
			}
			set
			{
				this._Katilanlars.Assign(value);
			}
		}
		...
		private void attach_Katilanlars(Katilanlar entity)
		{
			this.SendPropertyChanging();
			entity.Etkinlik = this;
		}
		
		private void detach_Katilanlars(Katilanlar entity)
		{
			this.SendPropertyChanging();
			entity.Etkinlik = null;
		}
	}
	...
	public partial class Katilanlar : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Etkinlik> _Etkinlik;
    ...
    partial void OnKidChanged();
		...
		public Katilanlar()
		{
			this._Etkinlik = default(EntityRef<Etkinlik>);
		...
		public int Eid
		{
			...
			set
			{
				if ((this._Eid != value))
				{
					if (this._Etkinlik.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Etkinlik_Katilanlar", Storage="_Etkinlik", ThisKey="Eid", OtherKey="EtkinlikId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Etkinlik Etkinlik
		{
			get
			{
				return this._Etkinlik.Entity;
			}
			set
			{
				Etkinlik previousValue = this._Etkinlik.Entity;
				if (((previousValue != value) 
							|| (this._Etkinlik.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Etkinlik.Entity = null;
						previousValue.Katilanlars.Remove(this);
					}
					this._Etkinlik.Entity = value;
					if ((value != null))
					{
						value.Katilanlars.Add(this);
						this._Eid = value.EtkinlikId;
					}
					else
					{
						this._Eid = default(int);
					}
					this.SendPropertyChanged("Etkinlik");
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Kullanici_Katilanlar", Storage="_Kullanici", ThisKey="Kid", OtherKey="Kid", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
	...
	public partial class Kullanici : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<KullaniciSpor> _KullaniciSpors;
    ...
    partial void OnisLoginChanged();
		...
		{
			this._Katilanlars = new EntitySet<Katilanlar>(new Action<Katilanlar>(this.attach_Katilanlars), new Action<Katilanlar>(this.detach_Katilanlars));
			this._KullaniciSpors = new EntitySet<KullaniciSpor>(new Action<KullaniciSpor>(this.attach_KullaniciSpors), new Action<KullaniciSpor>(this.detach_KullaniciSpors));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Kullanici_Katilanlar", Storage="_Katilanlars", ThisKey="Kid", OtherKey="Kid")]
		public EntitySet<Katilanlar> Katilanlars
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Kullanici_KullaniciSpor", Storage="_KullaniciSpors", ThisKey="Kid", OtherKey="Kid")]
		public EntitySet<KullaniciSpor> KullaniciSpors
		{
			get
			{
				return this._KullaniciSpors;
			}
			set
			{
				this._KullaniciSpors.Assign(value);
			}
		}
		...
		private void attach_KullaniciSpors(KullaniciSpor entity)
		{
			this.SendPropertyChanging();
			entity.Kullanici = this;
		}
		
		private void detach_KullaniciSpors(KullaniciSpor entity)
		{
			this.SendPropertyChanging();
			entity.Kullanici = null;
		}
	...
	public partial class KullaniciSpor : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Sporlar> _Sporlar;
    ...
    partial void OnSidChanged();
		...
		{
			this._Kullanici = default(EntityRef<Kullanici>);
			this._Sporlar = default(EntityRef<Sporlar>);
			OnCreated();
		}
		...
		public int Sid
		{
			...
			set
			{
				if ((this._Sid != value))
				{
					if (this._Sporlar.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnSidChanging(value);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Kullanici_KullaniciSpor", Storage="_Kullanici", ThisKey="Kid", OtherKey="Kid", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Kullanici Kullanici
		{
			get
			{
			...
			set
			{
							...
							|| (this._Kullanici.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Kullanici.Entity = null;
						previousValue.KullaniciSpors.Remove(this);
					}
					this._Kullanici.Entity = value;
					if ((value != null))
					{
						value.KullaniciSpors.Add(this);
						this._Kid = value.Kid;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Sporlar_KullaniciSpor", Storage="_Sporlar", ThisKey="Sid", OtherKey="SporId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Sporlar Sporlar
		{
			get
			{
				return this._Sporlar.Entity;
			}
			set
			{
				Sporlar previousValue = this._Sporlar.Entity;
				if (((previousValue != value) 
							|| (this._Sporlar.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Sporlar.Entity = null;
						previousValue.KullaniciSpors.Remove(this);
					}
					this._Sporlar.Entity = value;
					if ((value != null))
					{
						value.KullaniciSpors.Add(this);
						this._Sid = value.SporId;
					}
					else
					{
						this._Sid = default(int);
					}
					this.SendPropertyChanged("Sporlar");
				}
			}
		}
    ...
    partial void OnSporcuSayisiChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Sporlar_KullaniciSpor", Storage="_KullaniciSpors", ThisKey="SporId", OtherKey="Sid")]
		public EntitySet<KullaniciSpor> KullaniciSpors
		{
			get
			{
	...
	public partial class EtkinlikAlResult
	{
		...
		private System.Nullable<int> _Katilanlar;
		
		public EtkinlikAlResult()
		{
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_EtkinlikId", DbType="Int NOT NULL")]
		public int EtkinlikId
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Katilanlar", DbType="Int")]
		public System.Nullable<int> Katilanlar
		{
			get
			{
				return this._Katilanlar;
			}
			set
			{
				if ((this._Katilanlar != value))
				{
					this._Katilanlar = value;
				}
			}
		}
	}
